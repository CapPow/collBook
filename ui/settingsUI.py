...
class Ui_settingsWindow(object):
    def setupUi(self, settingsWindow):
        ...
        self.value_catalogNumberAssignProcessing = QtWidgets.QCheckBox(self.value_assignCatalogNumbers)
        self.value_catalogNumberAssignProcessing.setObjectName("value_catalogNumberAssignProcessing")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.value_catalogNumberAssignProcessing)
        ...
        self.formLayout_6.setItem(0, QtWidgets.QFormLayout.LabelRole, spacerItem3)
        ...
        self.selectionWidget.currentRowChanged['int'].connect(self.catalogNumberPage.setCurrentIndex)
    ...
    def retranslateUi(self, settingsWindow):
        ...
        item = self.selectionWidget.item(2)
        ...
        self.value_catalogNumberAssignProcessing.setText(_translate("settingsWindow", "Assign while processing"))
