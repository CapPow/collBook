...
class Ui_settingsWindow(object):
    def setupUi(self, settingsWindow):
        ...
        self.page_Display.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.page_Display.setResizeMode(QtWidgets.QListView.Adjust)
        ...
        self.value_assignCatalogNumbers.setEnabled(True)
        self.value_assignCatalogNumbers.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.value_assignCatalogNumbers.setCheckable(True)
        self.value_assignCatalogNumbers.setChecked(False)
        ...
        self.value_inc_Barcode.setChecked(False)
        self.value_inc_Barcode.setObjectName("value_inc_Barcode")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.value_inc_Barcode)
        self.value_use_UUIDCatalogNumbers = QtWidgets.QRadioButton(self.value_assignCatalogNumbers)
        self.value_use_UUIDCatalogNumbers.setChecked(True)
        self.value_use_UUIDCatalogNumbers.setAutoExclusive(True)
        self.value_use_UUIDCatalogNumbers.setObjectName("value_use_UUIDCatalogNumbers")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.value_use_UUIDCatalogNumbers)
        self.value_use_PatternCatalogNumbers = QtWidgets.QRadioButton(self.value_assignCatalogNumbers)
        self.value_use_PatternCatalogNumbers.setObjectName("value_use_PatternCatalogNumbers")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.value_use_PatternCatalogNumbers)
        ...
        self.value_catalogNumberPrefix.setEnabled(False)
        ...
        self.value_catalogNumberDigits.setEnabled(False)
        ...
        self.value_catalogNumberStartingNum.setEnabled(False)
        ...
        self.label_12 = QtWidgets.QLabel(self.value_assignCatalogNumbers)
        ...
        self.gridLayout_11 = QtWidgets.QGridLayout(self.labelIncludeGroup)
        ...
        self.gridLayout_11.addWidget(self.value_CollectionName, 4, 0, 1, 2)
        self.value_inc_FamilyName = QtWidgets.QCheckBox(self.labelIncludeGroup)
        self.value_inc_FamilyName.setObjectName("value_inc_FamilyName")
        self.gridLayout_11.addWidget(self.value_inc_FamilyName, 1, 0, 1, 1)
        ...
        self.value_italicize_Associated = QtWidgets.QCheckBox(self.labelIncludeGroup)
        self.value_italicize_Associated.setEnabled(True)
        self.value_italicize_Associated.setObjectName("value_italicize_Associated")
        self.horizontalLayout_7.addWidget(self.value_italicize_Associated)
        ...
        self.value_max_Associated.setEnabled(True)
        ...
        self.gridLayout_11.addWidget(self.value_inc_VerifiedBy, 6, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.value_inc_CollectionName, 3, 0, 1, 2)
        self.value_inc_TripName = QtWidgets.QCheckBox(self.labelIncludeGroup)
        self.value_inc_TripName.setObjectName("value_inc_TripName")
        self.gridLayout_11.addWidget(self.value_inc_TripName, 5, 0, 1, 2)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 911, 32))
        ...
        self.value_inc_Associated.toggled['bool'].connect(self.value_italicize_Associated.setEnabled)
        self.value_use_PatternCatalogNumbers.toggled['bool'].connect(self.value_catalogNumberPrefix.setEnabled)
        self.value_use_PatternCatalogNumbers.toggled['bool'].connect(self.value_catalogNumberStartingNum.setEnabled)
        self.value_use_PatternCatalogNumbers.toggled['bool'].connect(self.value_catalogNumberDigits.setEnabled)
        self.value_assignCatalogNumbers.toggled['bool'].connect(self.value_inc_Barcode.setChecked)
    ...
    def retranslateUi(self, settingsWindow):
        ...
        self.value_use_UUIDCatalogNumbers.setText(_translate("settingsWindow", "Generate 13-character long GUID based catalog numbers"))
        self.value_use_PatternCatalogNumbers.setText(_translate("settingsWindow", "Generate pattern based catalog numbers"))
        ...
        self.label_12.setText(_translate("settingsWindow", "( 1% chance of ID collision at approx. 35,040,000,000 specimens )"))
        ...
        self.value_inc_FamilyName.setText(_translate("settingsWindow", "Include family name"))
        ...
        self.value_italicize_Associated.setText(_translate("settingsWindow", "Italicize"))
        ...
        self.value_inc_TripName.setText(_translate("settingsWindow", "Include trip name"))
        ...
        self.value_TaxAlignSource.setItemText(2, _translate("settingsWindow", "Plants of the World (web API)"))
        self.value_TaxAlignSource.setItemText(3, _translate("settingsWindow", "Taxonomic Name Resolution Service (web API)"))
