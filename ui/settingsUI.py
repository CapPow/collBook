...
class Ui_settingsWindow(object):
    def setupUi(self, settingsWindow):
        ...
        self.label_sliderValue = QtWidgets.QLabel(self.value_inc_Logo)
        self.label_sliderValue.setText("")
        self.label_sliderValue.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_sliderValue.setObjectName("label_sliderValue")
        self.horizontalLayout_2.addWidget(self.label_sliderValue)
