...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 12 02:28:56 2019
...
if stream.open(QFile.ReadOnly):
    ...
    stream.close()
self.wordList = pd.read_csv(df, encoding = 'utf-8', dtype = 'str')['complete_name'].tolist()

class TextEdit(QTextEdit):
    def __init__(self, parent=None):
        super(TextEdit, self).__init__(parent)

        self.completer = QCompleter(sorted(self.wordList), self)
