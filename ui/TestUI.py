...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sciNamelineEdit = QtWidgets.QLineEdit(self.record_groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sciNamelineEdit.sizePolicy().hasHeightForWidth())
        self.sciNamelineEdit.setSizePolicy(sizePolicy)
        self.sciNamelineEdit.setMinimumSize(QtCore.QSize(40, 0))
        self.sciNamelineEdit.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.sciNamelineEdit.setObjectName("sciNamelineEdit")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.sciNamelineEdit)
