...
collBook is in an early release stage. **Please take caution with your data, and work on copies.** Pull requests, and comments are encouraged!
...
[Caleb Powell](https://github.com/CapPow) - MS Environmental Science, [Graduate Student - UTC](https://www.utc.edu/biology-geology-environmental-science/profiles/graduate-students/qvd441.php).
...
Dark Theme Provided By: [QDarkStylesheet](https://github.com/ColinDuquesnoy/QDarkStyleSheet)

Data Handling Support Provided by: [NumPy](https://numpy.org/) and [Pandas](https://pandas.pydata.org/)

PDF Support Provided by: [PyMuPDF](https://github.com/pymupdf/PyMuPDF) and [ReportLab](https://www.reportlab.com/)
...
Plants of the World Online. Facilitated by the Royal Botanic Gardens, Kew. Published on the Internet; http://www.plantsoftheworldonline.org/
